...
openwiki:
  ...
  source_paths: [src/dashboard.ts, src/dashboard-ui.ts, src/automode-main.ts, src/main-status-card.ts, src/coordinator.ts, src/ticket-session-main.ts, src/ticket-transcript.ts]
  symbols: [CoordinatorDashboard, DashboardProjection, DashboardCommand, HttpCoordinatorDashboard, createDashboardProjection, createAssistantTranscript, createAutomodeStatusCard]
