...
openwiki:
  ...
  test_paths: [test/startup.test.ts, test/main-session.test.ts, test/execution-inheritance.test.ts, test/coordinator-lock.test.ts, test/handoff.test.ts, test/launch-runtime.test.ts, test/dashboard.test.ts]
  ...
  validation_commands: [npm run build, "node --test dist/test/startup.test.js dist/test/main-session.test.js dist/test/execution-inheritance.test.js dist/test/coordinator-lock.test.js"]
---
