...
openwiki:
  ...
  source_paths: [src/panel-runtime.ts, src/panel-process.ts, src/ticket-panel-extension.ts, src/ticket-session-main.ts, src/nested-session.ts, src/launch.ts]
  symbols: [runGrillingPanel, runReviewPanel, PanelRuntimeError, CliPanelProcessLauncher, createProductionPanelSeatLauncher, createTicketPanelExtension, TicketPanelNestedActivity]
