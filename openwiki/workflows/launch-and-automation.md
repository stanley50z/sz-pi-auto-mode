...
openwiki:
  ...
  test_paths: [test/bridge.test.ts, test/selector.test.ts, test/stage-configuration.test.ts, test/launch-walkthrough.test.ts, test/execution-inheritance.test.ts, test/handoff.test.ts, test/launch-runtime.test.ts, test/main-status-card.test.ts, test/main-session.test.ts, test/dashboard.test.ts]
