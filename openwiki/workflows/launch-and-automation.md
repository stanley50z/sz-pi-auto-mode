...
openwiki:
  ...
  symbols: [createAutomationStageConfiguration, confirmSerializedAutomationStageConfiguration, handoffTerminal, requestReturnToNormalPi, startAutomodeMainSession]
  test_paths: [test/bridge.test.ts, test/selector.test.ts, test/stage-configuration.test.ts, test/launch-walkthrough.test.ts, test/handoff.test.ts, test/main-status-card.test.ts, test/dashboard.test.ts]
