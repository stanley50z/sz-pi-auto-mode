...
test("Full-Auto selects extension-owned stage skills and the fixed controlled surface", () => {
  const profile = createAutomodeCapabilityProfile(full);
